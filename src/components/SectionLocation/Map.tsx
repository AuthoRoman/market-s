...
const Map: React.FC<mapProps> = ({ stateLocation }) => {
  const srcIframe = {
    diur: "https://yandex.ru/map-widget/v1/?ll=53.416514%2C65.324319&mode=poi&poi%5Bpoint%5D=53.417916%2C65.325868&poi%5Buri%5D=ymapsbm1%3A%2F%2Fgeo%3Fdata%3DCgg1MzE0MDg4NxLEAdCg0L7RgdGB0LjRjywg0KDQtdGB0L_Rg9Cx0LvQuNC60LAg0JrQvtC80LgsINC80YPQvdC40YbQuNC_0LDQu9GM0L3Ri9C5INGA0LDQudC-0L0g0JjQttC10LzRgdC60LjQuSwg0LzRg9C90LjRhtC40L_QsNC70YzQvdC-0LUg0L7QsdGA0LDQt9C-0LLQsNC90LjQtSDQqdC10LvRjNGP0Y7RgCwg0L_QvtGB0ZHQu9C-0Log0KnQtdC70YzRj9GO0YAiCg3yq1VCFdimgkI%2C&z=14.59",
    krasnobor:
