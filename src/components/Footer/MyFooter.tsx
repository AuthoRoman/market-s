...
const MyFooter = () => {
  return (
    <div className="bg-footer-bg w-full h-[126px] flex  py-6 max-[915px]:h-[232px] max-[915px]:py-[40px]">
      <div className="m-[0_auto] w-[1208px] flex text-xs justify-between    max-[915px]:max-w-[304px] max-[915px]:relative ">
        <div className="flex   gap-10 max-w-[739px]      text-main-color   max-[1208px]:max-w-[415px] max-[915px]:flex-col max-[915px]:items-start max-[915px]:gap-6  ">
