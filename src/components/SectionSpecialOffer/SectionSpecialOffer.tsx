...
export const SectionSpecialOffer = () => {
  return (
    <div className="w-[1208px] m-auto flex flex-col gap-10 my-[120px] max-[1208px]:max-w-[736px]">
      <span className="font-bold text-[36px]">Специальные предложения</span>
      <div className="flex justify-between items-center">
        <div className="h-[200px] w-[574.85px] flex items-center justify-center rounded bg-[#FCD5BA] gap-[21px] hover:shadow-[0_8px_16px_0_rgba(202,147,96,0.5)] duration-100 ease-in hover:cursor-pointer max-[1208px]:max-w-[353px] max-[1208px]:max-h-[170px] max-[1208px]:p-5">
