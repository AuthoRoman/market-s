...
const Contacts = () => {
  return (
    <div className="m-[0_auto] max-w-[1208px] max-[1208px]:max-w-[736px] max-[900px]:max-w-[336px]">
      <div className="my-10">
        <div className="text-[64px] font-bold my-10">Контакты</div>
        <div className="flex gap-20 max-[900px]:flex-col">
          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="underline text-2xl font-bold">
                +7 908 716 33 97
              </div>
            </div>
          </div>
